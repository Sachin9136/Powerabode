...
import {
  Skillset_Development_banner,
  Skillset_Development_1,
  Skillset_Development_2,
  Skillset_Development_3,
  Skillset_Development_4,
  Card_img,
  one,
  two,
  three,
...
const About_us = () => {
  ...
  return (
    <>
      <CommanBanner
        children={Skillset_Development_banner}
        heading="Skillset Development for Cost & Commercial Impact
"
        subheading="For Project Managers, Contract Engineers, Field Supervisors, Technical Authorities, Finance, HSE, Cost Planning, Buyers, Work Preparatory, Job Holders etc
...
"
      ...
      <div className="px-4 md:px-20 my-10">
        <div>
          <h2 className="text-center text-3xl font-bold text-[#29385E] mt-6 mb-3">
            Local Content Development; Training is the key
          </h2>
        </div>
        ...
        <div className="my-10 block lg:flex justify-center gap-5">
          <div className="w-full lg:2/6 shadow-lg rounded-lg px-4 py-8 mb-6 bg-[#DCEEF0]">
            ...
            <div>
              <p className="text-medium font-medium">
                Powerabode academy and its training programs are designed for
                the ECMT (extended contact management teams) and its members.
                <br />
                Strong focus on Cost Efficiency and commercial results.
              </p>
            </div>
          </div>
          ...
          <div className="w-full lg:2/6 shadow-lg rounded-lg px-4 py-8 mb-6 bg-[#DCEEF0]">
            ...
            <div>
              <p className="text-medium font-medium">
                ...
                (ISC).They use & influence contracts everyday.Why the ECMT?
              </p>
          ...
          <div className="w-full lg:2/6 shadow-lg rounded-lg px-4 py-8 mb-6 bg-[#DCEEF0]">
            ...
            <div>
              <p className="text-medium font-medium">
                Integrated Supply Chain (ISC) is all about interdependence and
                synergy between Client and its contracts.
              </p>
              <p className="text-medium font-medium mt-3">
                Recognising and mastering these between multidisciplinary teams,
                is the key to cost efficiency and operational effectiveness.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="my-10 block lg:flex">
          <div className="w-full lg:w-1/2 px-0 md:px-10 lg:px-20">
            <div className="shadow-lg rounded-lg px-4 py-8 mb-10">
              <div>
                <h3 className="text-2xl font-bold text-[#29385E] mb-5">
                  Benefits?
                </h3>
              </div>
              <div>
                <p className="text-medium font-medium">
                  Transforms ECMT into a strong and effective delivery team.
                  <br />
            ...
            <div className="shadow-lg rounded-lg px-4 py-8 mb-10">
              ...
              <div>
                <p className="text-medium font-medium">
                  Own Contract of ECMT is used to customise the training
                </p>
                <p className="text-medium font-medium">
                  Trainers and coaches are Ex-IOC Frontline experienced Direct
                  transfer of learning in Contracts
                </p>
              </div>
            </div>
