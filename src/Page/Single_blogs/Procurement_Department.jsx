...
import { Dna_banner, Batch, Sla_tag, Supply_chain, Program_img, Why_powerabode_1, Why_powerabode_2, Why_powerabode_3, Why_powerabode_4, Why_powerabode_5, Why_powerabode_6, Why_powerabode_7, Why_powerabode_8, Codex, } from "../../components/Img/ImportedImage";
            ...
            <div className="block md:flex gap-5"> 
                <div className="w-full md:w-1/2 mt-3">
                    ...
                    <div className="border-2 border-[#eee] py-8 px-5 rounded-xl">
                        ...
                        <p className="mb-3">Contracting & Procurement or Supply Chain can be a separate department or placed under Projects, Asset, Legal or Finance. Each will give a different culture and result in its own challenges and biases. Only in a few cases it is at Executive Board Level – even where spend is in the multi-billion US$ .</p>
                        <p className="mb-3">An Asset/ Production C&P department is likely to be heavily focussed on Contract execution, a Finance CP department on cost and compliance, a Projects CP department on sourcing and tendering, Legal on standard Terms and conditions and claims handling. A standalone CP department, suitably lead, will have a broader understanding of Supply Chain – but senior level SCM professionals are hard to find. There are no easy solutions.</p>
                        <p className="mb-3">CP Audits or “commercial assurance” looks at the capabilities of the CP/Supply Chain department around the whole procurement cycle from Planning, through establishing contract strategies and bid lists, through tendering to award, mobilisation, contract execution and close out. It will also look at the quality of the key internal relationships. No Company’s CP department will be strong in all areas.</p>
                    </div>
                </div>
                <div className="w-full md:w-1/2 mt-3">
                    <div className="border-2 border-[#eee] py-8 px-5 rounded-xl">
                        <h5 className="mb-3 text-2xl text-[#1b3b64]">Common failings are:</h5>
                        <ul className="list-disc ml-5">
                            <li className="mb-2">A one size fits all approach increasing complexity for minor spend, and not giving a tailored enough approach for major projects.</li>
                            <li className="mb-2">Disconnects with finance on planning and budgets.</li>
                            <li className="mb-2">Poor market knowledge and use of that in determining contract strategies and bid-lists.</li>
                            <li className="mb-2">Lengthy Procurement times</li>
                            <li className="mb-2">Complex routine procurement – high numbers of low value transactions, POs and poor stock control</li>
                            <li className="mb-2">A lack of clarity on volumes and scope</li>
                            <li className="mb-2">Inadequate challenge and communication with technical departments</li>
                            <li className="mb-2">Technical and commercial evaluation models are poorly constructed</li>
                            <li className="mb-2">Document control and handling of external communication resulting in disputes and claims or poor audit trail for regulators.</li>
                            <li className="mb-2">Document review processes are lengthy or low quality.</li>
                            <li className="mb-2">Little or no structured post award contract management.</li>
                            <li className="mb-2">Work acceptance criteria and close out is not clearly defined.</li>
                            <li className="mb-2">Non-standard terms and conditions and insufficient expertise to resolve qualifications.</li>
                            <li className="mb-2">Compliance with required standards and due diligence.</li>
                            <li className="mb-2">The need to resort to expensive external counsel in claims mitigation.</li>
                        </ul>
                        <h5 className="mb-3 text-2xl text-[#1b3b64]">The Solution</h5>
                        <p className="mb-3">The full portfolio in powerabode Supply Chain by SLA remedies the typical findings that come out of audits on any procurement department.</p>
                        <h5 className="mb-3 text-2xl text-[#1b3b64]">Why powerabode?</h5>
                        <p className="mb-3">Because we focus on specialism. The products are dedicated to achieve cost efficiency, compliance and use frontline experts utilising industry best practice. The productised services allow for quick and cost efficient application.</p>
                    </div>
                </div>
            </div>
        </div>
