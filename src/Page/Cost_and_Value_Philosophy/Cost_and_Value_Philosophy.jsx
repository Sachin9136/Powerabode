    ...
    <>
      ...
      <Row>
        <div className="px-4 md:px-20 my-10">
          <div className="w-full">
            <div className='bg-white py-5'>
              <h2 className='text-center text-3xl font-bold text-[#29385E]'>Why do we need to embrace the Cost and Value Philosophy?</h2>
              <p className='text-center font-medium text-md my-2 p-0 md:px-15 lg:px-36'>Cost reduction targets come in regular intervals. And often they nothing more than that. A target. Every division, company or department then starts pushing. Without really ever going to the essence.</p>
              <p className='text-center font-medium text-md my-2 p-0 md:px-15 lg:px-36'>The Cost and Value Philosophy does that. It is embedded in all powerabode services and products. A powerful logic sits behind a system, breaking down cost and value across Specification, Efficiency and Rates. We help getting the targets delivered. Analysing operations, maintenance and production activities according to this framework empowers delivery of cost efficiency and value optimisation.</p>
            </div>
          </div>
        </div>
      </Row>
      ...
      <Row>
        <div className="px-4 md:px-20 my-10 block lg:flex justify-center gap-5">
          ...
          <div className="w-full lg:2/6 border-2 bg-[#51A9B433] rounded-lg shadow-lg px-8 pb-24 pt-16 mb-6">
            ...
            <div>
            <p className="text-center text-medium font-medium">A main potential of value and savings sit in the space of improved efficiency and rationalised specification. Together, they deliver an extra 70% of the cost saving potential. On top of the 20% in rate reductions. The final 10% is too expensive to achieve. Can you believe how inefficient the traditional approach of value and cost is?</p>
            </div>
          </div>
          ...
          <div className="w-full lg:2/6 border-2 bg-[#51A9B433] rounded-lg shadow-lg px-8 pb-24 pt-16 mb-6">
            ...
            <div>
            <p className="text-center text-medium font-medium">After splitting up the savings potential, we map the organisation into the stakeholders for each part of the potential. Our products and services are all designed to deliver on this logic. It basically takes the contract as a base, and then mobilises the users of a contract in the Extended Contract Management Team (ECMT). This ECMT is our first stepping stone into rolling out the philosophy and delivering of savings.</p>
            </div>
          </div>
        </div>
      </Row>
      ...
      <Row>
        <div className="px-4 md:px-20 my-10">
          <div className="w-full">
            <div className='bg-white py-5'>
              <h2 className='text-center text-3xl font-bold text-[#29385E]'>The ECMT</h2>
              <p className='text-center font-medium text-md my-2 p-0 md:px-15 lg:px-36'>The users of the contract!</p>
            </div>
          </div>
      ...
      <Row>
        <div className="px-4 md:px-20 my-10">
          <div className="w-full">
            <div className='bg-white py-5'>
              <h2 className='text-center text-3xl font-bold text-[#29385E] mb-1'>How We Deliver The Cost and Value Philosophy (C&V)?</h2>
              <h2 className='text-center text-3xl font-bold text-[#29385E] mb-4'>The Commercial Ecosystem</h2>
              <p className='font-medium text-md my-2'>The C&V Philosophy is the basis for the powerabode Commercial Ecosystem. It serves energy clients that want to optimise value and challenge their cost. We built and deliver a resilient Supply Chain and Procurement function. It has solutions for energy assets, as well as new energy start ups that require mature systems overnight. The system is also applicable for NOCs who aspire operatorship.</p>
              <p className='font-medium text-md my-2'>The strength powerabode brings is the integrated system of solutions, based on the C&V Philosophy. We introduce one, or more of the services, train the organisation, and work with you in the delivery.</p>
              <p className='font-medium text-md my-2'>Over 30 experts, all with IOC background support the delivery. This makes powerabode the partner for Outsourcing.</p>
            </div>
          </div>
        </div>
      </Row>
