            ...
            <div className="lg:flex my-10">
                <div className="w-full lg:w-1/2 px-3">
                    <div>
                        ...
                        <p className="text-xl font-medium lg:mr-12">We set up your Sourcing Strategy and establish alternative solutions. Risk assessed and robust.</p>
                    </div>
                </div>
                ...
                <div className="w-full lg:w-1/2 px-3">
                    <div>
                       ...
                       <ul className="list-disc ml-5">
                        <li className="text-xl mt-2">Yearly contracts, supported by SBLC, are subject to discount structures.</li>
                        <li className="text-xl mt-2">For governments and their NOC’s finance options are available.</li>
                       </ul>
                    </div>
                </div>
            </div>
            ...
            <div className="lg:flex my-10">
                <div className="w-full lg:w-1/2 px-3">
                    <div>
                        ...
                        <ul className="list-disc ml-5">
                            <li className="mt-2 text-xl">Set up of structure for operations of energy assets for National Oil Companies (NOC’s)</li>
                            <li className="mt-2 text-xl">Finance of new assets</li>
                            <li className="mt-2 text-xl">Program to develop NOC’s towards becoming an Operator</li>
                            <li className="mt-2 text-xl">Handover-model and Handover-program for assets. For example IOC stepping out, and handing over to the National Oil Company.</li>
                        </ul>
                    </div>
                </div>
                <div className="w-full lg:w-1/2 ">
