  ...
  const faqs = [
    {
      ...
      answer:
        "Popular career options include engineering, medicine, biotechnology, research, and many more. You can choose based on your interests and passion.",
    },
    {
      question: "What subjects should I focus on for a career in technology?",
      answer:
        "You should focus on subjects like mathematics, physics, computer science, and programming languages. These will form the base for your technology career.",
    },
    {
      question: "Is pursuing medical studies after 12th science a good option?",
      answer:
        "Yes, pursuing medical studies is a highly regarded option. It requires dedication, but it opens up many fields such as surgery, dentistry, and more.",
    },
  ];
